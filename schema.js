...
*/
query = client.query(' CREATE TABLE rank (USERNAME VARCHAR(15) PRIMARY KEY, TOTALPOINTS INTEGER DEFAULT 0 CHECK (TOTALPOINTS >=0 ) , POINTS_LVL INTEGER[10] DEFAULT 0 , LVL_BEST INTEGER[10] DEFUALT 0 ') ;
