...
*/
query = client.query('CREATE TABLE ranking ( USERNAME VARCHAR(15) PRIMARY KEY , POINTS INTEGER DEFAULT 0 CHECK ( POINTS >=0 
), LV1 INTEGER DEFAULT 0 , LV2 INTEGER DEFAULT 0 , LV3 INTEGER DEFAULT 0 , LV4 INTEGER DEFAULT 0 , LV5 INTEGER DEFAULT 0 , 
LV6 INTEGER DEFAULT 0 , LV7 INTEGER DEFAULT 0 , LV8 INTEGER DEFAULT 0, LV9 INTEGER DEFAULT 0 , LV10 INTEGER DEFAULT 0'); 
